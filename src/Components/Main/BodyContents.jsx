    ...
    <div className="overflow-hidden text-stone-900">
      ...
      <section className="h-screen bg-gray-100 flex flex-col items-center justify-center text-center p-10 fade-in">
        ...
        <p className="text-lg sm:text-xl text-stone-500 max-w-3xl">
          Discover the elegance of premium fashion and accessories. Our curated collection is designed to elevate your style and redefine sophistication.
        </p>
      </section>
      ...
      <section className="h-screen bg-white flex flex-col items-center justify-center text-center p-10 slide-right">
        ...
        <p className="text-lg sm:text-xl text-stone-500 max-w-3xl">
          At Volerhaut, we prioritize quality, craftsmanship, and timeless design. Our products are made to last and leave a lasting impression.
        </p>
      </section>
      ...
      <section className="h-screen flex flex-col items-center justify-center p-10 scale-up">
        <h2 className="text-4xl sm:text-6xl font-bold mb-6">Contact Us</h2>
        <p className="text-lg sm:text-xl mb-6">
          Have questions? Reach out to us and let us help you find the perfect style.
        </p>
